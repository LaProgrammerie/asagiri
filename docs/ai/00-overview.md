...
Détail produit : [`spec.md`](../archives/specs/spec.md) (historique V1 ; branding : [`spec-rename.md`](../archives/specs/spec-rename.md)). Index : [`archives/specs/README.md`](../archives/specs/README.md).
...
| Chemin | Rôle |
|--------|------|
| `docs/ai/archives/specs/` | Specs longues archivées (my-A…F, v3, phase finale, historique) |
| `docs/ai/active/` | Handoff + current-spec (exécution) |
