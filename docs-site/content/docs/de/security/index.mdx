...
Bei Hinweisen auf Rechteausweitung oder andere sicherheitsrelevante Schwächen siehe [`SECURITY.md`](https://github.com/LaProgrammerie/hyper-fast-builder/blob/main/SECURITY.md).
