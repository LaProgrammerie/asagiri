...
Behandeln Sie den MCP-Server wie jeden anderen lokalen Automatisierungs-Endpunkt: Er läuft unter Ihrer Nutzeridentität, mit Zugriff auf Ihr Checkout und auf die Werkzeuge, die Asagiri eingebunden hat.
