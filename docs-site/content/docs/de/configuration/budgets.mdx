...
Schätzungen multiplizieren heuristische Tokenzahlen mit den Raten aus `pricing`. Rechnungen der Anbieter können abweichen — etwa bei Tarifwechseln oder bei Abrechnungsfaktoren, die Asagiri nicht modelliert.
