...
`asa resume <run-id> --execute` verketten Schritte nur zusammen mit globalem **`--dry-run`**. Ohne Dry-Auto werden Agenten nicht automatisch erneut gestartet — den ausgegebenen Schritt manuell ausführen oder `continue` verwenden.
</Callout>
