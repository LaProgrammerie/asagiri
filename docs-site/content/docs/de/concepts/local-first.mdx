...
**Lokale Untersuchung und Kontextreduktion** sind ein erstklassiger Schritt vor den teuren Phasen. Asagiri kann vorher eingrenzen, was das Repository verlässt:

1. **`asa investigate <feature>`** — begrenztes Grep, Kandidatendateien, Warnungen bei großen Dateien, zugehörige Tests
2. **`asa context <feature> --optimize`** — Kontext sammeln, bewerten, in ein Pack verdichten
