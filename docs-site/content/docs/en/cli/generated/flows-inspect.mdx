---
title: Flows Inspect · Asagiri CLI
description: Afficher un résumé des flows extraits
---

CLI path: **`asa flows inspect`**
...
> Original CLI synopsis: Afficher un résumé des flows extraits

## Usage

```bash
asa flows inspect [flags]
```
