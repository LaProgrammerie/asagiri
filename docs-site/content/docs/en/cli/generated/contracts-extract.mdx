---
title: Contracts Extract · Asagiri CLI
description: Générer OpenAPI et contrats dérivés
---

CLI path: **`asa contracts extract`**
...
> Original CLI synopsis: Générer OpenAPI et contrats dérivés

## Usage

```bash
asa contracts extract [flags]
```
...
_No sibling commands at this depth (Contracts Extract)._
