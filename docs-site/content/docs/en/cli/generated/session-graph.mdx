---
title: Session Graph · Asagiri CLI
description: Afficher le graphe sessions/branches
---

CLI path: **`asa session graph`**
...
> Original CLI synopsis: Afficher le graphe sessions/branches

## Usage

```bash
asa session graph [flags]
```
...
- [Session Branch](./session-branch.mdx)
