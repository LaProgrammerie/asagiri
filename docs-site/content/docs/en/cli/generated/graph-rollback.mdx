---
title: Graph Rollback · Asagiri CLI
description: Marquer un graphe et ses nœuds actifs comme rolled back
---

CLI path: **`asa graph rollback`**
...
> Original CLI synopsis: Marquer un graphe et ses nœuds actifs comme rolled back

## Usage

```bash
asa graph rollback [flags]
```
...
```bash
asa graph rollback graph-2026-05-29-abcdef01
```
