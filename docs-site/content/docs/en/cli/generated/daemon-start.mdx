---
title: Daemon Start · Asagiri CLI
description: Démarrer le runtime local
---

CLI path: **`asa daemon start`**
...
> Original CLI synopsis: Démarrer le runtime local

## Usage

```bash
asa daemon start [flags]
```
...
| --- | --- | --- | --- |
| `--detach` | Local | `false` | Lancer le worker en arrière-plan |
