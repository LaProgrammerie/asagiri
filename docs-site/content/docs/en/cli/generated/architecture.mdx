---
title: Architecture · Asagiri CLI
description: Projeter les implications système depuis les flows
---

CLI path: **`asa architecture`**
...
> Original CLI synopsis: Projeter les implications système depuis les flows

## Usage

```bash
asa architecture [flags]
```
