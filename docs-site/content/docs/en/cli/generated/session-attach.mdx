---
title: Session Attach · Asagiri CLI
description: Attacher le terminal à une session
---

CLI path: **`asa session attach`**
...
> Original CLI synopsis: Attacher le terminal à une session

## Usage

```bash
asa session attach [flags]
```
