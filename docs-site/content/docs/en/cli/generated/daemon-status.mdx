---
title: Daemon Status · Asagiri CLI
description: État du runtime
---

CLI path: **`asa daemon status`**
...
> Original CLI synopsis: État du runtime

## Usage

```bash
asa daemon status [flags]
```
...
| `--rich` | Local | `false` | Affichage terminal enrichi (spec §24.20) |
