---
title: Cloud · Asagiri CLI
description: Commandes opt-in vers Asagiri Cloud. Le CLI reste 100 % fonctionnel sans compte.
---
...
> Original CLI synopsis: Intégration Team Cloud optionnelle (login, sync runs)
