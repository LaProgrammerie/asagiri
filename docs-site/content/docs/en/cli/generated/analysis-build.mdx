---
title: Analysis Build · Asagiri CLI
description: Construire les graphes d'analyse pour un produit
---

CLI path: **`asa analysis build`**
...
> Original CLI synopsis: Construire les graphes d'analyse pour un produit

## Usage

```bash
asa analysis build [flags]
```
...
| `--product` | Local | `(empty)` | Product id under .asagiri/products/ |
...
_No sibling commands at this depth (Analysis Build)._
