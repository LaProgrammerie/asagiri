---
title: Verify · Asagiri CLI
description: Exécuter les validations locales
---
...
| `--investigate-on-failure` | Local | `false` | Lancer une investigation locale si la vérification échoue |
