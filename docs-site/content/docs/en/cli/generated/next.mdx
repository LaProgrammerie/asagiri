---
title: Next · Asagiri CLI
description: Afficher ou exécuter la prochaine action recommandée
---
...
> Original CLI synopsis: Afficher ou exécuter la prochaine action recommandée
...
| `--execute` | Local | `false` | Exécuter la commande recommandée |
| `--feature` | Local | `(empty)` | Feature cible |
| `--no-trust` | Local | `false` | Masquer le résumé trust |
