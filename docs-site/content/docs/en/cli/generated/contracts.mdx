---
title: Contracts · Asagiri CLI
description: Extraire les contrats système depuis les flows
---

CLI path: **`asa contracts`**
...
> Original CLI synopsis: Extraire les contrats système depuis les flows
