---
title: Plan · AgentFlow CLI
description: Générer ou normaliser le plan de tâches
---

CLI path: **`agentflow plan`**
...
> Original CLI synopsis: Générer ou normaliser le plan de tâches

## Usage

```bash
agentflow plan [flags]
```
