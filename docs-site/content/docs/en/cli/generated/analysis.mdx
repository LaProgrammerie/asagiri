---
title: Analysis · Asagiri CLI
description: Analyse structurelle du code (graphes de dépendances)
---

CLI path: **`asa analysis`**
...
> Original CLI synopsis: Analyse structurelle du code (graphes de dépendances)
