...
description: Indexe le dépôt dans .asagiri/index/chunks.sqlite.
---
...
> Original CLI synopsis: Indexer le dépôt pour le RAG local (sémantique + mots-clés, spec §10.3)
...
| `--skip-embeddings` | Local | `false` | Indexer sans vecteurs (recherche LIKE uniquement) |
