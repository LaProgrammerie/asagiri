---
title: Trust Gates · Asagiri CLI
description: Afficher les gates de vérification configurées
---

CLI path: **`asa trust gates`**
...
> Original CLI synopsis: Afficher les gates de vérification configurées

## Usage

```bash
asa trust gates [flags]
```
