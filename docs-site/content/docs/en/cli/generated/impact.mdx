---
title: Impact · Asagiri CLI
description: Analyser l'impact des changements via le graphe
---
...
> Original CLI synopsis: Analyser l'impact des changements via le graphe
