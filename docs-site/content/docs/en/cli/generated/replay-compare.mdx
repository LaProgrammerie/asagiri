---
title: Replay Compare · Asagiri CLI
description: Comparer deux replay packages
---

CLI path: **`asa replay compare`**
...
> Original CLI synopsis: Comparer deux replay packages

## Usage

```bash
asa replay compare [flags]
```
