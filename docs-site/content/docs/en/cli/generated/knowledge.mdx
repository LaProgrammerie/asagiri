---
title: Knowledge · Asagiri CLI
description: Construire et interroger le graphe de connaissance
---

CLI path: **`asa knowledge`**
...
> Original CLI synopsis: Construire et interroger le graphe de connaissance
