---
title: Graph Status · Asagiri CLI
description: Afficher l'état d'un graphe
---

CLI path: **`asa graph status`**
...
> Original CLI synopsis: Afficher l'état d'un graphe

## Usage

```bash
asa graph status [flags]
```
...
```bash
asa graph status graph-20260529-001
```
