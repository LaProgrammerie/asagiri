---
title: Runtime Events · Asagiri CLI
description: Événements runtime
---

CLI path: **`asa runtime events`**
...
> Original CLI synopsis: Événements runtime

## Usage

```bash
asa runtime events [flags]
```
...
| `--follow` | Local | `false` | Suivre les nouveaux événements (poll court V1) |
...
- [Runtime Serve](./runtime-serve.mdx)
