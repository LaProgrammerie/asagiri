---
title: Context · Asagiri CLI
description: Afficher ou optimiser le contexte prévu
---

CLI path: **`asa context`**
...
> Original CLI synopsis: Afficher ou optimiser le contexte prévu
...
| `--from-graph` | Local | `false` | Enrichir le contexte depuis le graphe de connaissance |
| `--optimize` | Local | `false` | Afficher le résumé tokens |
| `--show` | Local | `false` | Afficher le contexte pack |
