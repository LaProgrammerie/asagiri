---
title: Architecture Derive · Asagiri CLI
description: Dériver API/async/sécurité/observabilité/infra
---

CLI path: **`asa architecture derive`**
...
> Original CLI synopsis: Dériver API/async/sécurité/observabilité/infra

## Usage

```bash
asa architecture derive [flags]
```
...
_No sibling commands at this depth (Architecture Derive)._
