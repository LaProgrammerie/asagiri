---
title: Report · AgentFlow CLI
description: Afficher le rapport d'un run
---

CLI path: **`agentflow report`**
...
> Original CLI synopsis: Afficher le rapport d'un run

## Usage

```bash
agentflow report [flags]
```
