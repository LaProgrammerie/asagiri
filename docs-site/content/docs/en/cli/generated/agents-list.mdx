---
title: Agents List · Asagiri CLI
description: Lister les AgentSpec (registry ou templates embarqués)
---

CLI path: **`asa agents list`**
...
> Original CLI synopsis: Lister les AgentSpec (registry ou templates embarqués)

## Usage

```bash
asa agents list [flags]
```
