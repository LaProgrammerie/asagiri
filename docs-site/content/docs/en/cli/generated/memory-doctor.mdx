---
title: Memory Doctor · Asagiri CLI
description: Vérifier Ollama, dimensions des embeddings et entrées orphelines
---

CLI path: **`asa memory doctor`**
...
> Original CLI synopsis: Vérifier Ollama, dimensions des embeddings et entrées orphelines

## Usage

```bash
asa memory doctor [flags]
```
