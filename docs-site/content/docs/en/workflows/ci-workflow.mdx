---
title: CI workflow
description: Use Asagiri in CI with dry-run, validation, and docs checks.
---
...
| Variable | Effect |
| --- | --- |
| `ASA_DRY_RUN=1` | Same as global `--dry-run` |
| `ASA_YES=1` | Auto-confirm prompts (use carefully in CI) |
