...
The living checklist, review expectations, and repository policies live in **[CONTRIBUTING.md](https://github.com/LaProgrammerie/hyper-fast-builder/blob/main/CONTRIBUTING.md)** at the repo root — start there for anything beyond this short map.
...
Public prose targets `docs-site/content/docs/` (English site uses Fumadocs). Internal canon and steering notes stay under `docs/ai/`. When code and docs disagree, [`problems.md`](https://github.com/LaProgrammerie/hyper-fast-builder/blob/main/problems.md) at the root tracks known drift.
