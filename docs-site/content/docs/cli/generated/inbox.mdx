---
title: Inbox · AgentFlow CLI
description: Lister les specs candidates depuis les sources
---

CLI path: **`agentflow inbox`**
...
> Original CLI synopsis: Lister les specs candidates depuis les sources

## Usage

```bash
agentflow inbox [flags]
```
...
| `--source` | Local | `(empty)` | Filtrer: notion\|local |
