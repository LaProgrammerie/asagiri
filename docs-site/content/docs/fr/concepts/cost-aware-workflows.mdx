...
<Callout type="cost">
Les estimations sont **approximatives**. La facturation fournisseur utilise de vrais tokenizers ; AgentFlow ne fournit pas encore de compteurs exacts fournisseur.
</Callout>
