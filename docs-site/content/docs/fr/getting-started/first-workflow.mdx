...
description: Flux AgentFlow bout en bout depuis init jusqu’au rapport avec de vraies commandes CLI.
---
...
La reprise auto hors dry-run complète n’est pas implémentée. Préférez `agentflow continue` pour continuer par intention.
</Callout>
