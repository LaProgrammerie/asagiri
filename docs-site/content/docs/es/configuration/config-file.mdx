...
description: Referencia completa de los bloques y valores predeterminados de .agentflow/config.yaml.
---
...
| Bloque | Propósito |
| --- | --- |
| `sources.local` | Escanear `.agentflow/specs`, `.kiro/specs`, `docs/ai/active` |
