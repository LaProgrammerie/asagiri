...
description: Recorrido completo AgentFlow desde init hasta el informe con comandos CLI reales.
---
...
Reanudación automática fuera del dry-run completo no existe. Prefiera `agentflow continue` para continuar por intención.
</Callout>
