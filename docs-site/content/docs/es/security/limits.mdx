---
title: Límites
description: Lo que Asagiri no promete y fronteras conocidas del producto.
---

# Límites

Asagiri destaca ordenando automatización disciplinada, pero cada orquestador apoyado en LLMs hereda aristas delicadas. Debajo están las **fronteras de confianza** explícitas de **`spec-doc` §17.1** junto capacidades donde sí puede ayudarte.

## Asagiri no hace estas promesas
