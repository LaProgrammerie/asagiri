...
Ce fichier est celui que `castor init` utilise comme README produit. Pour la **couche template** (IA, Yoimachi, lien avec le README composite), voir aussi `README.md` à la racine du dépôt template et `docs/ai/02-architecture.md`.
